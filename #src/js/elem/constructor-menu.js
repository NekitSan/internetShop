let CONSTRUCTOR = function () 
{
    ...
    /* Action */
    let colorList = $(".colorList-item");
    let block_tovar = $(".constructor_part-block");
    
    let shadowList = $(".backlightList-item");
    let shadow_tovar = $(".constructor_part-background_block");

    let sizeList = $(".sizeList-item");

    let setList = $(".setList-item");
    /* #Action# */
